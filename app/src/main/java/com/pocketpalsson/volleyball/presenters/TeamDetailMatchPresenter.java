...
import com.pocketpalsson.volleyball.views.TeamDetailMatchListView;
...
public class TeamDetailMatchPresenter extends MvpBasePresenter<TeamDetailMatchListView> {
    ...
    public void loadMatches() {
        ...
        Observable.from(matchIds)
                .flatMap(federationMatchNumber -> SimpleURLFetcher.getInstance("http://caspermunk.dk/livescore/xml").getResponse(federationMatchNumber + ".xml"))
                .flatMap(response -> {
