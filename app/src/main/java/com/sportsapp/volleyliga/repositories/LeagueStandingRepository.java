...
import com.sportsapp.volleyliga.repositories.xmlParsers.LeagueStandingXmlPullParser;
        ...
        Observable.from(new League[]{League.MALE, League.FEMALE})
                .doOnNext(league -> {
                    ...
                    try {
                        ...
                        response = client.newCall(new Request.Builder().url("http://volleyapp.dk/rankings/" + path + ".xml").build()).execute();
