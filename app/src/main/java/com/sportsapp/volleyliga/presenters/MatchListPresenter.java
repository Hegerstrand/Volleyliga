...
//                });
    ...
    private void addMatch(MatchModel input) {
        matchDict.put(input.federationMatchNumber, input);
        matches = new ArrayList<>(matchDict.values());
